...
4. 在普通目标浏览器中人工验收 WebGL 初始化、点击进入视角、鼠标锁定、WASD/方向键、Esc 释放和边界行为。
...
- 2026-08-13：加入第一人称 FreeCamera、重力、地面碰撞、鼠标锁定/ Esc 释放提示与 WebGL 初始化错误降级；尚未进行真实浏览器人工验收。
